    ...
    return (
      <main block="Checkout">
        <div block="ProgressBar">
          <div block="Same-lines">
            <div
              block={
                "Red-colored-lines " +
                (this.state.counter >= 0 ? "Full-width" : "")
              }
            ></div>
          </div>
          <div block="ProgressBar-Number">
            <div>
              <span
                block={
                  "Red-colored-span " +
              ...
              ></span>
              <p block={"Gray-P " + (this.state.counter >= 0 ? "White-P" : "")}>
                <span
                  block={
                    "Span-number " +
                    (this.state.counter >= 1 ? "Opacity-0" : "")
                  }
                >
                  1
                </span>
                <span
                  block={
                    "Empty-span " + (this.state.counter >= 1 ? "Opacity-1" : "")
                  }
                ></span>
              </p>
            </div>
            <p block={"Gray-P " + (this.state.counter >= 0 ? "Black-P" : "")}>
              Shipping
            </p>
          </div>
          <div block="Different-line">
            <div
              block={
                "Red-colored-lines " +
                (this.state.counter >= 1 ? "Full-width" : "")
              }
            ></div>
          </div>
          <div block="ProgressBar-Number">
            <div>
              ...
              ></span>
              <p block={"Gray-P " + (this.state.counter >= 1 ? "White-P" : "")}>
                <span
                  block={
                    "Span-number " +
                    (this.state.counter >= 2 ? "Opacity-0" : "")
                  }
                >
                  2
                </span>
                <span
                  block={
                    "Empty-span " + (this.state.counter >= 2 ? "Opacity-1" : "")
                  }
                ></span>
              </p>
            </div>
            <p block={"Gray-P " + (this.state.counter >= 1 ? "Black-P" : "")}>
              Review &#38; paymant
            </p>
          </div>
          <div block="Same-lines">
            <div
              block={
                "Red-colored-lines " +
                (this.state.counter >= 2 ? "Full-width" : "")
              }
            ></div>
          </div>
        </div>
